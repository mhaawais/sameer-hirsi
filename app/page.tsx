...
// Dynamically load the homepage content (client component)
...
export const metadata: Metadata = {
  ...
  description:
    'Official site for the Beyond Reach Point Zero, Destiny Point or Critical Point books by Sameer Hirsi.',
};
